<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="tip_dealer.aspx.cs" Inherits="Pretty_Gaming.Menu_Report.tip_dealer" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" set-lan="text:Tip Dealer"></li>
        </ol>
    </nav>
    <div class="row">
        <div class="col-md-12">
            <h1 set-lan="text:Tip Dealer"></h1>
        </div>
    </div>
    ...
    <div class="table-wrapper" style="overflow: auto; margin-bottom: 10px; width: 100%; display: block;" id="tb">
        <div style="display: flex;">
            <div class="navCur" style="margin-top: 1rem;">
                <label style="font-weight: bold;" set-lan="text:Currency_">Currency :</label>
                THB</div>
            <div style="border-bottom: 33.5px solid #CFA137; border-right: 50px solid transparent;"></div>
        </div>
        <section style="margin-top: -2.3rem; float: right;">
            <div class="data-container"></div>
            <div id="pagination-THB">
        ...
        <table class="table table-border" id="tbTHB" style="margin-bottom: 1rem;">
            <thead class="rgba-green-slight" style="text-align: center;">
                <tr>
                    <th style="width: 6%; vertical-align: middle; border-radius: initial !important; background-color: rgb(23, 23, 44); color: #f2e8be; border: 1px #ced4da solid;">No</th>
                    <th style="width: 15%; vertical-align: middle; text-align: left; padding-left: 5px; background-color: rgb(23, 23, 44); color: #f2e8be; border: 1px #ced4da solid;">Delear name</th>
                    <th style="width: 10%; vertical-align: middle; text-align: right; padding-right: 5px; background-color: rgb(23, 23, 44); color: #f2e8be; border: 1px #ced4da solid;">Game type</th>
                    <th style="width: 9%; vertical-align: middle; text-align: right; padding-right: 5px; background-color: rgb(23, 23, 44); color: #f2e8be; border: 1px #ced4da solid;">Tip</th>
                </tr>
            </thead>
            <tbody>
                <tr>
                    ...
                    <td>
                        <p onclick="" class="link overflowlg ellipsis" title="ambth">ambth</p>
                    </td>
                    <td class="alignright">Bacarrat</td>
                    <td class="alignright">441,751.00</td>
                </tr>
                <tr>
                    <td style="text-align: center;">2</td>
                    <td>
                        <p onclick="" class="link overflowlg ellipsis" title="nokshareholder">nokshareholder</p>
                    </td>
                    <td class="alignright">Dragon Tiger</td>
                    <td class="alignright">28,519.00</td>
                </tr>
                <tr>
                    <td style="text-align: center;">3</td>
                    <td>
                        <p onclick="" class="link overflowlg ellipsis" title="expgroup">expgroup</p>
                    </td>
                    <td class="alignright">Bacarrat</td>
                    <td class="alignright">8,000.00</td>
                </tr>
                <tr>
                    <td style="text-align: center;">4</td>
                    <td>
                        <p onclick="" class="link overflowlg ellipsis" title="askmebet">askmebet</p>
                    </td>
                    <td class="alignright">Bacarrat</td>
                ...
                <tr>
                    ...
                    <td>
                        <p onclick="" class="link overflowlg ellipsis" title="prettytest">prettytest</p>
                    </td>
                    <td class="alignright">Bacarrat</td>
                    <td class="alignright">72.00</td>
                </tr>
            </tbody>
            <tfoot class="rgba-yellow-slight">
                <tr>
                    <td style="font-weight: bold; background-color: #f2e8be; border-right: 1px #ced4da solid;"></td>
                    <td style="font-weight: bold; background-color: #f2e8be; border-right: 1px #ced4da solid;"></td>
                    <td style="font-weight: bold; background-color: #f2e8be; border-right: 1px #ced4da solid;" set-lan="text:Total">Total :</td>
                    <td style="font-weight: bold; background-color: #f2e8be; border-right: 1px #ced4da solid;">478,992.00</td>
                </tr>
            </tfoot>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainScript" runat="server">
    ...
    <script>
        ...
        function chkAll(ele) {
            if (ele.checked) {
                $('input.chk[value="Baccarat"], input.chk[value="4Point"], input.chk[value="Super6"], input.chk[value="CowCow"], input.chk[value="DragonTiger"], input.chk[value="Roulette"], input.chk[value="SicBo"]').prop('checked', true);
            } else {
                $('input.chk[value="Baccarat"], input.chk[value="4Point"], input.chk[value="Super6"], input.chk[value="CowCow"], input.chk[value="DragonTiger"], input.chk[value="Roulette"], input.chk[value="SicBo"]').prop('checked', false);
            }
        }
