<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="member_and_agent_management.aspx.cs" Inherits="Pretty_Gaming.member_and_agent_management" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active txtMem" set-lan="text:Members & Agents"></li>
        </ol>
    </nav>
    <div class="row">
        <div class="col-md-7">
            <h1 set-lan="text:Members & Agents"></h1>
        </div>
        <%--<div class="col-md-5" style="text-align: right;">
            <a href="/Menu_MemberManagement/member_agent_add_member_credit.aspx" id="btnAddMem" class="btn btn-primary zonenone" set-lan="html:Add Member_"></a>
            <a href="/Menu_MemberManagement/agent_add.aspx" class="btn btn-primary zonenone" id="btnAddAgent" set-lan="html:Add Agent_"></a>
        </div>--%>
    </div>
