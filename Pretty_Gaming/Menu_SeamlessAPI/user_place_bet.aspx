<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="user_place_bet.aspx.cs" Inherits="Pretty_Gaming.Menu_SeamlessAPI.user_place_bet" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="" set-lan="text:Seamless API"></a></li>
            <li class="breadcrumb-item active" set-lan="text:User Place Bet"></li>
        </ol>
    </nav>
    <div class="row">
        <div class="col-md-8">
            <h1 set-lan="text:User Place Bet"></h1>
        </div>
    </div>
