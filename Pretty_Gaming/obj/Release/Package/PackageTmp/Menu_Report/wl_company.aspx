<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="wl_company.aspx.cs" Inherits="Pretty_Gaming.Menu_Report.wl_company" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" set-lan="text:W/L Company"></li>
        </ol>
    </nav>
    <div class="row">
        <div class="col-md-12">
            <h1 set-lan="text:W/L Company"></h1>
        </div>
    </div>
    <div class="btn-toolbar section-group" role="toolbar" style="padding-bottom: 0px !important;">
        <div class="col-md-12 row">
            ...
            <div class="form-group row fieldLogin filterCom" style="padding-left: 2rem;">
        ...
        <div class="col-md-12 row">
            <div class="form-group row fieldStart" style="padding-left: 1.6rem;">
        ...
        <div class="col-md-12 row" style="margin-top: -5px;">
            <div class="form-group row fieldBet" style="padding-left: 2.2rem;">
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainScript" runat="server">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            GetData2(_id, currency, start, end, starttime, endtime, "", "", localStorage.getItem("Position"));
        ...
        function btnSearch(event) {
            ...
            if ($("#searchLoginname").val() == "") {
                GetData2(_id, currency, $('#startdate').val(), $('#todate').val(), $('#starttime').val(), $('#totime').val(), "", event, localStorage.getItem("Position"));
            }
            else {
                    ...
                    success: function (data) {
                        if (data.code == 0 || data.code == null) {
                            if (data.data.position.toLowerCase() != "member_none_api" && data.data.position.toLowerCase() != "member_api") {
                                GetData2(data.data._id, currency, $('#startdate').val(), $('#todate').val(), $('#starttime').val(), $('#totime').val(), "", event, localStorage.getItem("Position"));
                            }
                            else {
                ...
                success: function (data) {
                    if (data.code == 0 || data.code == null) {
                        if (txtNo == 0) {
                            ...
                            var htmlMenu = "";
                            for (var ii = 0; ii < dataMenu.length; ii++) {
                                var objMenu = dataMenu[ii];
                                if ((dataMenu.length - 1) == ii) {
                                    if (ii == 0) {
                                        if (objMenu.position.toLowerCase() == "member_none_api" || objMenu.position.toLowerCase() == "member_api") {
                                            ...
                                            htmlMenu += "<a class='linkNav' onclick='GetData2(\"" + objMenu._id + "\" ,[\"Main\"], \"" + startDate + "\", \"" + toDate + "\", \"" + startTime + "\", \"" + toTime + "\", \"nav\", \"\", \"" + objMenu.position + "\")'>" + objMenu.username + "</a>";
                                        }
                                    }
                                    else {
                                        if (objMenu.position.toLowerCase() == "member_none_api" || objMenu.position.toLowerCase() == "member_api") {
                                            ...
                                            htmlMenu += "<a class='linkNav' onclick='GetData2(\"" + objMenu._id + "\" ,[\"" + curtxt + "\"], \"" + startDate + "\", \"" + toDate + "\", \"" + startTime + "\", \"" + toTime + "\", \"nav\", \"\", \"" + objMenu.position + "\")'>" + objMenu.username + "</a>";
                                        }
                                    }
                                }
                                else {
                        ...
                        if (data.data.list.length > 0) {
                            if (navArrLast == "COMPANY") {
                                ...
                                for (var j = 0; j < dataTotal.length; j++) {
                                    var obj = dataTotal[j];
                                    var com = obj._id._id;
                                    if (arrAllData.some(item => item.name === com) == true) {
                                        var index = arrAllData.findIndex(item => item.name === com);
                                        arrAllData[index]['data'].push({
                                            "_id": "" + obj._id._id + "", "currency": "" + curtxt + "", "username": "" + obj._id.username + "", "position": "" + obj._id.position + "",
                                            "turnOverAmt": "" + obj.turnOverAmt + "",
                                            "validAmt": "" + obj.validAmt + "",
                                            "winLose": "" + obj.winLose + "",
                                            "winLoseTips": "" + obj.winLoseTips + "",
                                            "grossCom": "" + obj.grossCom + "",
                                            "memberTotalBet": "" + obj.memberTotalBet + "",
                                            "memberPayoutCom": "" + obj.memberPayoutCom + "",
                                            "memberPayoutTotal": "" + obj.memberPayoutTotal + "",
                                            "ptTotalBet": "" + obj.ptTotalBet + "",
                                            "ptPayoutCom": "" + obj.ptPayoutCom + "",
                                            "ptPayoutTotal": "" + obj.ptPayoutTotal + "",
                                            "comTotalBet": "" + obj.comTotalBet + "",
                                            "comPayoutCom": "" + obj.comPayoutCom + "",
                                            "comPayoutTotal": "" + obj.comPayoutTotal + "",
                                            "countTicket": "" + obj.countTicket + ""
                                        });
                                    }
                                    no++;
                                }
                            }
                            else if (navArrLast == "B2B_SH_HOLDER" || navArrLast == "B2C_SH_HOLDER") {
                                $(".filterCom").css("display", "flex");
                                var arr = data.data.list;
                                var dataTotal = arr.sort(rankingSorter("turnOverAmt"));
                                var no = 1;
                            ...
                            else if (navArrLast == "MEMBER_NONE_API" || navArrLast == "MEMBER_API") {
                                ...
                                htmlData += "<th rowspan='2' style='width: 6%; vertical-align: middle; text-align: right; padding-right: 5px; background-color: rgb(23, 23, 44); color: #f2e8be; border: 1px #ced4da solid;' set-lan='text:Tips'></th>";
                                ...
                                for (var y = 0; y < dataTotal.length; y++) {
                                    ...
                                    if (obj._id.position == "MEMBER_NONE_API" || obj._id.position == "MEMBER_API") {
                                        ...
                                        htmlData += "<td><p onclick='GetData2(\"" + obj._id._id + "\" ,[\"" + curtxt + "\"],\"" + startDate + "\", \"" + toDate + "\", \"" + startTime + "\", \"" + toTime + "\", \"nav\", \"\", \"" + obj._id.position + "\")' class='link overflow ellipsis' title='" + obj._id.username + "'>" + obj._id.username + "</p></td>";
                                    }
                    ...
                    if (check == cur.length) {
                        if (arrAllData.length > 0) {
                            var htmlDataCom = "";
                            if (navArrLast == "COMPANY") {
                                for (var k = 0; k < arrAllData.length; k++) {
                                    if (arrAllData[k].data.length > 0) {
                                        var txtHeadExcel = arrAllData[k].username;
                                        htmlDataCom += '<div style="display: flex;"><div class="navCur" style="margin-top: 1rem;">' + txtHeadExcel + '</div><div style="border-bottom: 33.5px solid #CFA137; border-right: 50px solid transparent;"></div></div>';

                                        htmlDataCom += '<table class="table table-border" id="tb' + arrAllData[k].name + '" style="margin-bottom: 1rem;"><thead class="rgba-green-slight" style="text-align: center;">';
                                        htmlDataCom += "<tr>";
                                        htmlDataCom += "<th colspan='10' style='display:none; vertical-align: middle; background-color: #CFA137; color: #fff; border: 1px #ced4da solid;'>" + txtHeadExcel + "</th>";
                                        htmlDataCom += "</tr>";
                                        htmlDataCom += "<tr>";
                                        htmlDataCom += "<th rowspan='2' style='width: 6%; vertical-align: middle; border-radius: initial !important; background-color: rgb(23, 23, 44); color: #f2e8be; border: 1px #ced4da solid;' set-lan='text:No'></th>";
                                        htmlDataCom += "<th rowspan='2' style='width: 15%; vertical-align: middle; text-align: left; padding-left: 5px; background-color: rgb(23, 23, 44); color: #f2e8be; border: 1px #ced4da solid;' set-lan='text:Currency'></th>";
                                        htmlDataCom += "<th rowspan='2' style='width: 10%; vertical-align: middle; text-align: right; padding-right: 5px; background-color: rgb(23, 23, 44); color: #f2e8be; border: 1px #ced4da solid;' set-lan='text:Turnover'></th>";
                                        htmlDataCom += "<th rowspan='2' style='width: 10%; vertical-align: middle; text-align: right; padding-right: 5px; background-color: rgb(23, 23, 44); color: #f2e8be; border: 1px #ced4da solid;' set-lan='text:Valid turn'></th>";
                                        htmlDataCom += "<th rowspan='2' style='width: 9%; vertical-align: middle; text-align: right; padding-right: 5px; background-color: rgb(23, 23, 44); color: #f2e8be; border: 1px #ced4da solid;' set-lan='text:No.Ticket'></th>";
                                        htmlDataCom += "<th rowspan='2' style='width: 10%; vertical-align: middle; text-align: right; padding-right: 5px; background-color: rgb(23, 23, 44); color: #f2e8be; border: 1px #ced4da solid;' set-lan='text:Gross Comm'></th>";
                                        htmlDataCom += "<th rowspan='2' style='width: 10%; vertical-align: middle; text-align: right; padding-right: 5px; background-color: rgb(23, 23, 44); color: #f2e8be; border: 1px #ced4da solid;'><label style='margin-bottom: 0rem;' set-lan='text:Member W/L'></label></th>";
                                        htmlDataCom += "<th rowspan='2' style='width: 10%; vertical-align: middle; text-align: right; padding-right: 5px; background-color: rgb(23, 23, 44); color: #f2e8be; border: 1px #ced4da solid;' set-lan='text:Tips'></th>";
                                        htmlDataCom += "<th colspan='3' style='vertical-align: middle; background-color: rgb(23, 23, 44); color: #f2e8be; border: 1px #ced4da solid;' set-lan='text:Company'></th>";
                                        htmlDataCom += "</tr>";
                                        htmlDataCom += "<tr>";
                                        htmlDataCom += "<th style='width: 10%; text-align: right; padding-right: 5px; background-color: rgb(23, 23, 44); color: #f2e8be; border: 1px #ced4da solid;' set-lan='text:Win lose'></th>";
                                        htmlDataCom += "<th style='width: 10%; text-align: right; padding-right: 5px; background-color: rgb(23, 23, 44); color: #f2e8be; border: 1px #ced4da solid;' set-lan='text:Comm'></th>";
                                        htmlDataCom += "<th style='border-radius: 0px !important; width: 10%; text-align: right; padding-right: 5px; background-color: rgb(23, 23, 44); color: #f2e8be; border: 1px #ced4da solid;' set-lan='text:Total-'></th>";
                                        htmlDataCom += "</tr>";
                                        htmlDataCom += '</thead><tbody>';

                                        var arr = arrAllData[k].data;

                                        var dataTB = arr.sort(rankingSorter("turnOverAmt"));
                                        var no = 1;
                                        for (var l = 0; l < dataTB.length; l++) {
                                            var obj = dataTB[l];
                                            htmlDataCom += "<tr>";
                                            htmlDataCom += "<td style='text-align: center;'>" + no + "</td>";

                                            if (obj.position == "MEMBER_NONE_API" || obj.position == "MEMBER_API") {
                                                htmlDataCom += "<td><p onclick='GetDataTableMember(\"" + obj._id + "\" ,\"" + obj.currency + "\",\"" + startDate + "\", \"" + toDate + "\", \"" + startTime + "\", \"" + toTime + "\")' class='link overflowlg ellipsis' title='" + obj.currency + "'>" + obj.currency + "</p></td>";
                                            }
                                            else {
                                                htmlDataCom += "<td><p onclick='GetData2(\"" + obj._id + "\" ,[\"" + obj.currency + "\"],\"" + startDate + "\", \"" + toDate + "\", \"" + startTime + "\", \"" + toTime + "\", \"nav\", \"\", \"" + obj.position + "\")' class='link overflowlg ellipsis' title='" + obj.currency + "'>" + obj.currency + "</p></td>";
                                            }

                                            var turnOverAmt = parseFloat(obj.turnOverAmt).toFixed(2);
                                            if (obj.turnOverAmt < 0 || obj.turnOverAmt.toString() == "-0.00") {
                                                htmlDataCom += "<td class='alignright' style='color: red;'>" + turnOverAmt.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, '$1,') + "</td>";
                                            }
                                            else {
                                                htmlDataCom += "<td class='alignright'>" + turnOverAmt.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, '$1,') + "</td>";
                                            }

                                            var validAmt = parseFloat(obj.validAmt).toFixed(2);
                                            if (obj.validAmt < 0 || obj.validAmt.toString() == "-0.00") {
                                                htmlDataCom += "<td class='alignright' style='color: red;'>" + validAmt.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, '$1,') + "</td>";
                                            }
                                            else {
                                                htmlDataCom += "<td class='alignright'>" + validAmt.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, '$1,') + "</td>";
                                            }

                                            htmlDataCom += "<td class='alignright'>" + obj.countTicket.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, '$1,') + "</td>";

                                            var grossCom = parseFloat(obj.grossCom).toFixed(2);
                                            if (obj.grossCom < 0 || obj.grossCom.toString() == "-0.00") {
                                                htmlDataCom += "<td class='alignright' style='color: red;'>" + grossCom.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, '$1,') + "</td>";
                                            }
                                            else {
                                                htmlDataCom += "<td class='alignright'>" + grossCom.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, '$1,') + "</td>";
                                            }

                                            var winLose = parseFloat(obj.winLose).toFixed(2);
                                            if (obj.winLose < 0 || obj.winLose.toString() == "-0.00") {
                                                htmlDataCom += "<td class='alignright' style='color: red;'>" + winLose.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, '$1,') + "</td>";
                                            }
                                            else {
                                                htmlDataCom += "<td class='alignright'>" + winLose.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, '$1,') + "</td>";
                                            }

                                            var winLoseTips = parseFloat(obj.winLoseTips).toFixed(2);
                                            if (obj.winLoseTips < 0 || obj.winLoseTips.toString() == "-0.00") {
                                                htmlDataCom += "<td class='alignright' style='color: red;'>" + winLoseTips.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, '$1,') + "</td>";
                                            }
                                            else {
                                                htmlDataCom += "<td class='alignright'>" + winLoseTips.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, '$1,') + "</td>";
                                            }

                                            var ptTotalBet = parseFloat(obj.ptTotalBet).toFixed(2);
                                            if (obj.ptTotalBet < 0 || obj.ptTotalBet.toString() == "-0.00") {
                                                htmlDataCom += "<td class='alignright' style='color: red;'>" + ptTotalBet.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, '$1,') + "</td>";
                                            }
                                            else {
                                                htmlDataCom += "<td class='alignright'>" + ptTotalBet.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, '$1,') + "</td>";
                                            }

                                            var ptPayoutCom = parseFloat(obj.ptPayoutCom).toFixed(2);
                                            if (obj.ptPayoutCom < 0 || obj.ptPayoutCom.toString() == "-0.00") {
                                                htmlDataCom += "<td class='alignright' style='color: red;'>" + ptPayoutCom.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, '$1,') + "</td>";
                                            }
                                            else {
                                                htmlDataCom += "<td class='alignright'>" + ptPayoutCom.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, '$1,') + "</td>";
                                            }

                                            var ptPayoutTotal = parseFloat(obj.ptPayoutTotal).toFixed(2);
                                            if (obj.ptPayoutTotal < 0 || obj.ptPayoutTotal.toString() == "-0.00") {
                                                htmlDataCom += "<td class='alignright' style='color: red;'>" + ptPayoutTotal.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, '$1,') + "</td>";
                                            }
                                            else {
                                                htmlDataCom += "<td class='alignright'>" + ptPayoutTotal.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, '$1,') + "</td>";
                                            }
                                        ...
                                        htmlDataCom += '</tbody><tfoot class="rgba-yellow-slight">';

                                        htmlDataCom += "<tr><td style='text-align: center;' colspan='11'></td>";
                                        htmlDataCom += "</tr>";
                                        htmlDataCom += '<caption style="display: none;">&nbsp;</caption>';
                                        htmlDataCom += '</tfoot>';
                                        htmlDataCom += '</table>';
                                    }
                                }
                                ...
                                for (var k = 0; k < arrAllData.length; k++) {
                                    if (arrAllData[k].data.length > 0) {
                                        ...
                                        htmlDataCom += '<table class="table table-border" id="tb' + arrAllData[k].name + '" style="margin-bottom: 1rem;"><thead class="rgba-green-slight" style="text-align: center;">';
                                        htmlDataCom += "<tr>";
                                        htmlDataCom += "<th colspan='16' style='display:none; vertical-align: middle; background-color: #CFA137; color: #fff; border: 1px #ced4da solid;'>" + txtHeadExcel + "</th>";
                                        htmlDataCom += "</tr>";
                                        htmlDataCom += "<tr>";
                                        htmlDataCom += "<th rowspan='2' style='width: 2.5%; vertical-align: middle; border-radius: initial !important; background-color: rgb(23, 23, 44); color: #f2e8be; border: 1px #ced4da solid;' set-lan='text:No'></th>";
                                        htmlDataCom += "<th rowspan='2' style='width: 7.5%; vertical-align: middle; text-align: left; padding-left: 5px; background-color: rgb(23, 23, 44); color: #f2e8be; border: 1px #ced4da solid;' set-lan='text:Currency'></th>";
                                        htmlDataCom += "<th rowspan='2' style='width: 6%; vertical-align: middle; text-align: right; padding-right: 5px; background-color: rgb(23, 23, 44); color: #f2e8be; border: 1px #ced4da solid;' set-lan='text:Turnover'></th>";
                                        htmlDataCom += "<th rowspan='2' style='width: 6%; vertical-align: middle; text-align: right; padding-right: 5px; background-color: rgb(23, 23, 44); color: #f2e8be; border: 1px #ced4da solid;' set-lan='text:Valid turn'></th>";
                                        htmlDataCom += "<th rowspan='2' style='width: 4%; vertical-align: middle; text-align: right; padding-right: 5px; background-color: rgb(23, 23, 44); color: #f2e8be; border: 1px #ced4da solid;' set-lan='text:No.Ticket'></th>";
                                        htmlDataCom += "<th rowspan='2' style='width: 6%; vertical-align: middle; text-align: right; padding-right: 5px; background-color: rgb(23, 23, 44); color: #f2e8be; border: 1px #ced4da solid;' set-lan='text:Gross Comm'></th>";
                                        htmlDataCom += "<th rowspan='2' style='width: 10%; vertical-align: middle; text-align: right; padding-right: 5px; background-color: rgb(23, 23, 44); color: #f2e8be; border: 1px #ced4da solid;'><label style='margin-bottom: 0rem;' set-lan='text:Member W/L'></label></th>";
                                        htmlDataCom += "<th rowspan='2' style='width: 6%; vertical-align: middle; text-align: right; padding-right: 5px; background-color: rgb(23, 23, 44); color: #f2e8be; border: 1px #ced4da solid;' set-lan='text:Tips'></th>";
                                        htmlDataCom += "<th colspan='3' style='width: 18%; vertical-align: middle; background-color: rgb(23, 23, 44); color: #f2e8be; border: 1px #ced4da solid;' set-lan='text:Member'></th>";
                                        htmlDataCom += "<th colspan='3' style='width: 18%; vertical-align: middle; background-color: rgb(23, 23, 44); color: #f2e8be; border: 1px #ced4da solid;' set-lan='text:Agent'></th>";
                                        htmlDataCom += "<th colspan='3' style='width: 18%; vertical-align: middle; background-color: rgb(23, 23, 44); color: #f2e8be; border: 1px #ced4da solid;' set-lan='text:Company'></th>";
                                        htmlDataCom += "</tr>";
                                        htmlDataCom += "<tr>";
                                        htmlDataCom += "<th style='border-radius: 0px !important; width: 6%; text-align: right; padding-right: 5px; background-color: rgb(23, 23, 44); color: #f2e8be; border: 1px #ced4da solid;' set-lan='text:Win lose'></th>";
                                        htmlDataCom += "<th style='width: 6%; text-align: right; padding-right: 5px; background-color: rgb(23, 23, 44); color: #f2e8be; border: 1px #ced4da solid;' set-lan='text:Comm'></th>";
                                        htmlDataCom += "<th style='width: 6%; text-align: right; padding-right: 5px; background-color: rgb(23, 23, 44); color: #f2e8be; border: 1px #ced4da solid;' set-lan='text:Total-'></th>";
                                        htmlDataCom += "<th style='width: 6%; text-align: right; padding-right: 5px; background-color: rgb(23, 23, 44); color: #f2e8be; border: 1px #ced4da solid;' set-lan='text:Win lose'></th>";
                                        htmlDataCom += "<th style='width: 6%; text-align: right; padding-right: 5px; background-color: rgb(23, 23, 44); color: #f2e8be; border: 1px #ced4da solid;' set-lan='text:Comm'></th>";
                                        htmlDataCom += "<th style='width: 6%; text-align: right; padding-right: 5px; background-color: rgb(23, 23, 44); color: #f2e8be; border: 1px #ced4da solid;' set-lan='text:Total-'></th>";
                                        htmlDataCom += "<th style='width: 6%; text-align: right; padding-right: 5px; background-color: rgb(23, 23, 44); color: #f2e8be; border: 1px #ced4da solid;' set-lan='text:Win lose'></th>";
                                        htmlDataCom += "<th style='width: 6%; text-align: right; padding-right: 5px; background-color: rgb(23, 23, 44); color: #f2e8be; border: 1px #ced4da solid;' set-lan='text:Comm'></th>";
                                        htmlDataCom += "<th style='border-radius: 0px !important; width: 6%; text-align: right; padding-right: 5px; background-color: rgb(23, 23, 44); color: #f2e8be; border: 1px #ced4da solid;' set-lan='text:Total-'>Total</th>";
                                        htmlDataCom += "</tr>";
                                        htmlDataCom += '</thead><tbody>';
                                        ...
                                        for (var l = 0; l < dataTB.length; l++) {
                                            ...
                                            var memberTotalBet = parseFloat(obj.memberTotalBet).toFixed(2);
                                            if (obj.memberTotalBet < 0 || obj.memberTotalBet.toString() == "-0.00") {
                                                htmlDataCom += "<td class='alignright' style='color: red; background-color: #fff9e06b; border: 1px #ced4da solid;'>" + memberTotalBet.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, '$1,') + "</td>";
                                            }
                                            else {
                                                htmlDataCom += "<td class='alignright' style='background-color: #fff9e06b; border: 1px #ced4da solid;'>" + memberTotalBet.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, '$1,') + "</td>";
                                            }

                                            var memberPayoutCom = parseFloat(obj.memberPayoutCom).toFixed(2);
                                            if (obj.memberPayoutCom < 0 || obj.memberPayoutCom.toString() == "-0.00") {
                                                htmlDataCom += "<td class='alignright' style='color: red; background-color: #fff9e06b; border: 1px #ced4da solid;'>" + memberPayoutCom.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, '$1,') + "</td>";
                                            }
                                            else {
                                                htmlDataCom += "<td class='alignright' style='background-color: #fff9e06b; border: 1px #ced4da solid;'>" + memberPayoutCom.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, '$1,') + "</td>";
                                            }

                                            var memberPayoutTotal = parseFloat(obj.memberPayoutTotal).toFixed(2);
                                            if (obj.memberPayoutTotal < 0 || obj.memberPayoutTotal.toString() == "-0.00") {
                                                htmlDataCom += "<td class='alignright' style='color: red; background-color: #fff9e06b; border: 1px #ced4da solid;'>" + memberPayoutTotal.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, '$1,') + "</td>";
                                            }
                                            else {
                                                htmlDataCom += "<td class='alignright' style='background-color: #fff9e06b; border: 1px #ced4da solid;'>" + memberPayoutTotal.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, '$1,') + "</td>";
                                            }

                                            var ptTotalBet = parseFloat(obj.ptTotalBet).toFixed(2);
                                            if (obj.ptTotalBet < 0 || obj.ptTotalBet.toString() == "-0.00") {
                                                htmlDataCom += "<td class='alignright' style='color: red; background-color: #fcea9e75; border: 1px #ced4da solid;'>" + ptTotalBet.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, '$1,') + "</td>";
                                            }
                                            else {
                                                htmlDataCom += "<td class='alignright' style='background-color: #fcea9e75; border: 1px #ced4da solid;'>" + ptTotalBet.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, '$1,') + "</td>";
                                            }

                                            var ptPayoutCom = parseFloat(obj.ptPayoutCom).toFixed(2);
                                            if (obj.ptPayoutCom < 0 || obj.ptPayoutCom.toString() == "-0.00") {
                                                htmlDataCom += "<td class='alignright' style='color: red; background-color: #fcea9e75; border: 1px #ced4da solid;'>" + ptPayoutCom.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, '$1,') + "</td>";
                                            }
                                            else {
                                                htmlDataCom += "<td class='alignright' style='background-color: #fcea9e75; border: 1px #ced4da solid;'>" + ptPayoutCom.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, '$1,') + "</td>";
                                            }

                                            var ptPayoutTotal = parseFloat(obj.ptPayoutTotal).toFixed(2);
                                            if (obj.ptPayoutTotal < 0 || obj.ptPayoutTotal.toString() == "-0.00") {
                                                htmlDataCom += "<td class='alignright' style='color: red; background-color: #fcea9e75; border: 1px #ced4da solid;'>" + ptPayoutTotal.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, '$1,') + "</td>";
                                            }
                                            else {
                                                htmlDataCom += "<td class='alignright' style='background-color: #fcea9e75; border: 1px #ced4da solid;'>" + ptPayoutTotal.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, '$1,') + "</td>";
                                            }

                                            var comTotalBet = parseFloat(obj.comTotalBet).toFixed(2);
                                            if (obj.comTotalBet < 0 || obj.comTotalBet.toString() == "-0.00") {
                                                htmlDataCom += "<td class='alignright' style='color: red; background-color: #ffd06373; border: 1px #ced4da solid;'>" + comTotalBet.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, '$1,') + "</td>";
                                            }
                                            else {
                                                htmlDataCom += "<td class='alignright' style='background-color: #ffd06373; border: 1px #ced4da solid;'>" + comTotalBet.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, '$1,') + "</td>";
                                            }

                                            var comPayoutCom = parseFloat(obj.comPayoutCom).toFixed(2);
                                            if (obj.comPayoutCom < 0 || obj.comPayoutCom.toString() == "-0.00") {
                                                htmlDataCom += "<td class='alignright' style='color: red; background-color: #ffd06373; border: 1px #ced4da solid;'>" + comPayoutCom.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, '$1,') + "</td>";
                                            }
                                            else {
                                                htmlDataCom += "<td class='alignright' style='background-color: #ffd06373; border: 1px #ced4da solid;'>" + comPayoutCom.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, '$1,') + "</td>";
                                            }

                                            var comPayoutTotal = parseFloat(obj.comPayoutTotal).toFixed(2);
                                            if (obj.comPayoutTotal < 0 || obj.comPayoutTotal.toString() == "-0.00") {
                                                htmlDataCom += "<td class='alignright' style='color: red; background-color: #ffd06373; border: 1px #ced4da solid;'>" + comPayoutTotal.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, '$1,') + "</td>";
                                            }
                                            else {
                                                htmlDataCom += "<td class='alignright' style='background-color: #ffd06373; border: 1px #ced4da solid;'>" + comPayoutTotal.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, '$1,') + "</td>";
                                            }
                                            htmlDataCom += "</tr>";
                                            no++;
                                        }
                                        ...
                                        htmlDataCom += '</tbody><tfoot class="rgba-yellow-slight">';
                                        htmlDataCom += "<tr><td style='text-align: center;' colspan='17'></td>";
                                        htmlDataCom += "</tr>";
                                        htmlDataCom += '<caption style="display: none;">&nbsp;</caption>';
                                        htmlDataCom += '</tfoot>';
                                        htmlDataCom += '</table>';
                                ...
                                if (dataMenu[0]._id == _id && dataMenu[0].position == "COMPANY" && dataMenu.length == 1) {
                                    ...
                                    for (var i = 0; i < dataTotal.length; i++) {
                                        ...
                                        if (obj._id.position == "MEMBER_NONE_API" || obj._id.position == "MEMBER_API") {
                                            ...
                                            htmlData += "<td><p onclick='GetData2(\"" + obj._id._id + "\" ,[\"" + curtxt + "\"],\"" + startDate + "\", \"" + toDate + "\", \"" + startTime + "\", \"" + toTime + "\", \"nav\", \"\")' class='link overflowlg ellipsis' title='" + obj._id.username + "'>" + obj._id.username + "</p></td>";
                                        }
                                    ...
                                    for (var i = 0; i < dataTotal.length; i++) {
                                        ...
                                        if (obj._id.position == "MEMBER_NONE_API" || obj._id.position == "MEMBER_API") {
                                            ...
                                            htmlData += "<td><p onclick='GetData2(\"" + obj._id._id + "\" ,[\"" + curtxt + "\"],\"" + startDate + "\", \"" + toDate + "\", \"" + startTime + "\", \"" + toTime + "\", \"nav\", \"\")' class='link overflow ellipsis' title='" + obj._id.username + "'>" + obj._id.username + "</p></td>";
                                        }
        ...
        function GetData2(var1, var2, startD, toD, startT, toT, nav, event, position) {
            check = 0;
            $("#myModalLoad").modal();
            ...
            GetDropdownUser(var1, var2, startD, toD, startT, toT, 0, event, position);
        }

        var check = 0;
        var c = 0;
        function getDatas(var1, var2, startD, toD, startT, toT, x, arrs, event) {
            arrAllData = arrs;
            for (c = x; c < var2.length; c++) {
                GetData(var1, var2, startD, toD, startT, toT, c, event);
            }
        }

        function GetDropdownUser(x, xx, startDate, toDate, startTime, toTime, m, event, position) {
                    ...
                    success: function (data) {
                        if (data.code == null || data.code == 0) {
                            ...
                            for (var i = 0; i < arrDataLength; i++) {
                                ...
                                var myJson = { "name": arrData[i]._id._id, "username": arrData[i]._id.username, "data": [] };
                                arrs.push(myJson);
                            }
                            ...
                            getDatas(x, xx, startDate, toDate, startTime, toTime, m, arrs, event);
                        }
                        else {
                            document.getElementById('lbAlert').innerHTML = data.msg;
                            $("#myModalLoad").modal('hide');
