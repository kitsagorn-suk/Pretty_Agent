<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="user_place_bet_cancel.aspx.cs" Inherits="Pretty_Gaming.Menu_SeamlessAPI.user_place_bet_cancel" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" set-lan="text:User Place Bet Cancel"></li>
        </ol>
    </nav>
    <div class="row">
        <div class="col-md-8">
            <h1 set-lan="text:User Place Bet Cancel"></h1>
        </div>
    </div>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainScript" runat="server">
    ...
    <script type="text/javascript">
        ...
        function GetData(page, limit) {
            ...
            $.ajax({
                url: apiURL + "/apiRoute/reportRouter/seamlessApi/userPlaceBetCancel",
                type: 'POST',
                dataType: 'json',
