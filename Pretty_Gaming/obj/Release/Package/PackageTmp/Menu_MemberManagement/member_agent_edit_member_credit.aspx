<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="member_agent_edit_member_credit.aspx.cs" Inherits="Pretty_Gaming.Menu_MemberManagement.member_agent_edit_member_credit" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" set-lan="text:Edit Member"></li>
        </ol>
    </nav>
    <h1 set-lan="text:Edit Member">Edit Member</h1>
                ...
                <div class="form-row">
                    <div class="form-group col-6">
                        <div class="form-group row inputform">
                            ...
                            <div class="col-8">
                                <input type="text" class="form-control" autocomplete="off" id="username" disabled="disabled" />
                            </div>
                        </div>
                        <div class="form-group row inputform">
                ...
                <div class="form-row">
                    <div class="form-group col-6">
                        ...
                        <div class="form-group row inputform">
                            ...
                            <div class="col-8">
                                <input type="text" class="form-control" autocomplete="off" id="credit" disabled="disabled" />
                            </div>
                        </div>
                        <div class="form-group row inputform">
                    ...
                    <div class="col-12" style="text-align: center;">
                        <button class="btn btn-yellow font-weight-bold" onclick="EditMember()" type="button" set-lan="text:Save"></button>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                    ...
                    <div class="section-group mb-4">
                        ...
                        <div class="form-row">
                            <div class="form-group col-6">
                                ...
                                <div class="form-group row inputform">
                                    <label for="currency" class="col-4 col-form-label" set-lan="text:Currency" style="text-align: left;"></label>
                                    <div class="col-8">
                                        <input type="text" class="form-control" autocomplete="off" id="currencyView" disabled="disabled" />
                                    </div>
                                </div>
                                <div class="form-group row inputform">
                                    <label for="credit" class="col-4 col-form-label" set-lan="text:Credit" style="text-align: left;"></label>
                                    <div class="col-8">
                                        <input type="text" class="form-control" autocomplete="off" id="creditView" disabled="disabled" />
                                    </div>
                                </div>
                                <div class="form-group row inputform">
                                    <label for="pt" class="col-4 col-form-label" set-lan="html:Bet Limit" style="text-align: left;"></label>
                                    <div class="col-8">
                                        <%--<input type="text" id="BetLimitView" class="form-control" autocomplete="off" disabled="disabled" />--%>
                                        <textarea id="BetLimitView" class="form-control" autocomplete="off" rows="2" readonly></textarea>
                                    </div>
                                </div>
                                <div class="form-group row inputform">
                                    <label for="pt" class="col-4 col-form-label" set-lan="html:Our PT" style="text-align: left;"></label>
                                    <div class="col-4">
                                        <input type="text" id="OurPTView" class="form-control" autocomplete="off" disabled="disabled" />
                                    </div>
                                </div>
                            </div>
                            <div class="form-group col-6">
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainScript" runat="server">
    <script>
        ...
        $(document).ready(function () {
            ...
            //$('#creditHelper').text('Min 0, Max ' + localStorage.getItem("Balance").toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, '$1,'));
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.code == null || data.code == 0) {
                        ...
                        $("#ddl_positiontracking option[value='" + data.positionTracking + "']").attr("selected", "selected");

                        var arrBet = data.betLimit;
                                ...
                                if (data.code == null || data.code == 0) {
                                    ...
                                    for (var i = 0; i < arrDataLength; i++) {
                                        if (arrData[i].currency == MainCurrency) {
                                            var txtLimitID = arrData[i].limitId;
                                            if (arrBet.indexOf(txtLimitID) > -1) {
                                                htmlBet += "<option value=" + arrData[i].limitId + " selected>" + arrData[i].min + " - " + arrData[i].max + "</option>";
                                            }
                                            else {
                        ...
                        if (data.logs.length > 0) {
                            ...
                            for (var h = 0; h < countHis.length; h++) {
                                ...
                                htmlHis += "<td class='aligncenter'><a attr-user='" + countHis[h].username + "' attr-nick='" + countHis[h].nickname + "' attr-tel='" + countHis[h].tel + "' attr-sus='" + countHis[h].isSuspend + "' attr-lock='" + countHis[h].isLocked + "' attr-cur='" + countHis[h].currency + "' attr-credit='" + countHis[h].balance.$numberDecimal + "' attr-bet='" + countHis[h].betLimit + "' attr-pt='" + countHis[h].positionTracking + "' attr-bac='" + parseFloat(countHis[h].commission.normalBaccarat).toFixed(1) + "' attr-cow='" + parseFloat(countHis[h].commission.cowCowBaccarat).toFixed(1) + "' attr-dra='" + parseFloat(countHis[h].commission.dragonTiger).toFixed(1) + "' attr-four='" + parseFloat(countHis[h].commission.fourPointBaccarat).toFixed(1) + "' attr-rou='" + parseFloat(countHis[h].commission.roulette).toFixed(1) + "' attr-sic='" + parseFloat(countHis[h].commission.sicBo).toFixed(1) + "' attr-sup='" + parseFloat(countHis[h].commission.super6Baccarat).toFixed(1) + "' onclick='GetHistoryItem(this);' style='color: #CFA137; font-weight: bold;'>" + txtDate + "</a></td>";
                                htmlHis += "<td>";
        ...
        function GetHistoryItem(els) {
            ...
            var arrBet = els.getAttribute('attr-bet');
            var arrBetTotal = [];
            $.ajax({
                type: "GET",
                url: apiURL + "/apiRoute/betLimit/list",
                ...
                success: function (data) {
                    ...
                    for (var i = 0; i < arrDataLength; i++) {
                        var txtLimitID = arrData[i].limitId;
                        if (arrBet.indexOf(txtLimitID) > -1) {
                            arrBetTotal.push(arrData[i].min + " - " + arrData[i].max);
                            console.log(arrBet + " : " + txtLimitID);
                        }
                    }
                    $("#BetLimitView").val(arrBetTotal);
                }
            });
            ...
            $("#OurPTView").val(els.getAttribute('attr-pt') + "%");
